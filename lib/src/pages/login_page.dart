      ...
      child: Column(
        children: <Widget>[
          ...
          FlatButton(
            ...
            onPressed: ()=> Navigator.pushNamed(context, 'reestablecer_psw'),
          ),
...
_login(LoginBloc bloc, BuildContext context) async {
    Map<String,String> logRta = await _auth.logear(bloc.email, bloc.password);

      if ( logRta['Error'] == 'OK' ) {
       Navigator.pushReplacementNamed(context, 'home');
    } else {
      mostrarAlerta( context, logRta['Error'] + ": " + logRta['Message'] );
    }
}
